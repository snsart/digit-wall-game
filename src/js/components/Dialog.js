					...
					<div className='DialogFooter'>
						{
							...
							<Button className="cancelBtn" onClick={this.props.onAction.bind(this,'dismiss')}>取消</Button>
							:null
						}
						<Button className="confirmBtn" onClick={this.props.onAction.bind(this,this.props.hasCancel?'confirm':'dismiss')}>
